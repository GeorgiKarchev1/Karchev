...
export const metadata: Metadata = {
  title: 'Казуси от реални уеб и automation проекти',
  description: 'Първите crawlable case studies на Karchev: как мислим структура, доверие, automation и conversion logic в реални проекти.',
  alternates: localizedAlternates('/bg/kazusi', '/en/case-studies', 'bg'),
}

const bgCases = [caseStudies.bgYordan, caseStudies.bgEditing]

export default function BulgarianCaseStudiesPage() {
  return (
    <main className="min-h-screen bg-[#f1f0ea] text-[#2d232e] selection:bg-[#534b52]/30">
      ...
      <section className="pt-40 pb-20 px-6 md:px-8 max-w-[1200px] mx-auto">
        <p className="text-xs font-black uppercase tracking-[0.22em] text-[#534b52]">Казуси</p>
        <h1 className="mt-5 text-5xl md:text-7xl font-black leading-[0.94] tracking-tight">
          Реални проекти,
          <span className="block text-[#534b52]">не просто портфолио картинки.</span>
        </h1>
      </section>
